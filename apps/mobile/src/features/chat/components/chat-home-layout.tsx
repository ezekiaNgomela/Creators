...
import type { ChatContact, ChatMessage } from "@/src/services/api";
    ...
    >
      ...
      >
        ...
        <View style={{ flexDirection: "row", gap: spacing.sm, flexWrap: "wrap" }}>
          <StatCard label="Unread" value={`${filteredContacts.length}`} />
          <StatCard label="Call ready" value={activeContact ? firstName(activeContact.name) : "Now"} accent />
          <StatCard label="Connected" value={`${contacts.length}`} />
        </View>
      </View>
